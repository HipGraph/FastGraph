...
*/
	bool show_time = true;
	short input_method = 1; //assigning 0 means input method is through rand_matrix from COO.h, 1 means that the input method is through files generated by rand_matrix_gen.m

	int x = 10, y = 4;   // these(this one and one below) lines are needed if input method is 0
	bool weighted = true;
