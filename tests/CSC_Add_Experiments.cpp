...
*/
	...
	int x = 20, y = 8;   // these(this one and one below) lines are needed if input method is 0
	bool weighted = true;

	//int k = 50; // number of matrices, default being 50
	int k = 100; // number of matrices, default being 50
    ...
    for(int i = 0; i < 3; i++){
        ...
        //if(option == 1){
            ...
            clock.Stop();
            if(show_time) std::cout<<"time for add_vec_of_matrices_1 function in seconds = "<< clock.Seconds()<<std::endl;
            //result_1.print_all();
        //}
        //else if(option == 2){
            clock.Start();
            ...
            clock.Stop();
            if(show_time) std::cout<<"time for add_vec_of_matrices_2 function in seconds = "<< clock.Seconds()<<std::endl;
            //result_2.print_all();
        //}
        //else if(option == 3){
            clock.Start();
            ...
            clock.Stop();
            if(show_time) std::cout<<"time for add_vec_of_matrices_3 function in seconds = "<< clock.Seconds()<<std::endl;
            //result_3.print_all();
        //}
        //else if(option == 4){
            clock.Start();
            ...
            clock.Stop();
            if(show_time) std::cout<<"time for add_vec_of_matrices_4 function in seconds = "<< clock.Seconds()<<std::endl;
            //result_4.print_all();
        //}
        //else if(option == 5){
            clock.Start();
            ...
            clock.Stop();
            if(show_time) std::cout<<"time for add_vec_of_matrices_5 function in seconds = "<< clock.Seconds()<<std::endl;
            //result_5.print_all();
        //}
        //else if(option == 6){
            clock.Start();
            ...
            clock.Stop();
            if(show_time) std::cout<<"time for add_vec_of_matrices_6 function in seconds = "<< clock.Seconds()<<std::endl;
            //result_6.print_all();
        //}
